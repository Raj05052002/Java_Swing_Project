...
public class SignupThree extends JFrame implements ActionListener
{
	...
	SignupThree(String formno)
	{
		...
		JLabel carddetails = new JLabel("Your 16Digit Card Number");
		...
		JLabel pindetails = new JLabel("Your 4 Digit Card PIN");
    ...
    public void actionPerformed(ActionEvent ae)
    {
    	if(ae.getSource() == submit) {
    		...
    		try {
    			if (accountType == null || facility.isEmpty() || !c7.isSelected()) {
